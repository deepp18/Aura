          ...
          <div>
            <Left>
              <h2 className="max-w-lg text-4xl font-bold md:text-5xl text-black">
                Grow emotionally with our 
                <span className="text-[#662d91]"> intelligent wellness solution</span>
              </h2>
            </Left>
            {/* <div>
                        <Text />
          ...
          <div className="relative">
            <Center>
              <div className="w-full flex items-center gap-4 font-bold text-7xl">
                ...
                <span className="tracking-wide text-black">AURA</span>
              </div>
          ...
          <div className="">
            <Right>
              ...
              <div className="text-lg font-semibold text-[#662d91]">
                ...
                <span className=" text-black">Transform It.</span>
              </div>
            </Right>
            {/* <div>
                        <Text />
